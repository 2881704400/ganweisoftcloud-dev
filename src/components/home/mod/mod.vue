							...
							<div class="modDetailMenu">
								<ul class="menuList">
									...
									<li class="menuItem">
										...
										<div class="titleTxt">
											<p>为设备画像，让每台设备具备独特的形象和性格，进而提供区别化的创新服务</p>
										</div>
									</li>
									...
									<li class="menuItem">
										...
										<div class="titleTxt">
											<p>基于工业设备的大数据信用与资产质量评级， 客观、实时的解决金融痛点问题：信用、风险、资产管理</p>
										</div>
									</li>
								</ul>
							...
							<div class="modDetailMenu">
								<ul class="menuList">
									...
									<li class="menuItem">
										...
										<div class="titleTxt">
											<p>丰富的物联应用帮助用户方便高效地查看工况，分析预测故障，以及管理设备</p>
										</div>
									</li>
							...
							<div class="modDetailMenu">
								<ul class="menuList">
									...
									<li class="menuItem">
										...
										<div class="titleTxt">
											<p>提供稳定可靠，价格低廉，灵活易用，安全保障的云计算全系列产品和服务</p>
										</div>
									</li>
									<li class="menuItem">
										<div class="title">
										...
										<div class="titleTxt">
											<p>对不同数据源的数据智能地进行探索、清洗、验证、融合、挖掘、发布等工作</p>
										</div>
									</li>
							...
							<div class="modDetailMenu">
								<ul class="menuList">
									...
									<li class="menuItem">
										...
										<div class="titleTxt">
											<p>根云物联硬件产品组帮助各种移动和固定设备方便又稳定地发送数据，连接入网</p>
										</div>
									</li>
									<li class="menuItem">
										<div class="title">
										...
										<div class="titleTxt">
											<p>提供高稳定可扩展的数据端到端通道，以及提供丰富的设备模型和解析服务</p>
										</div>
									</li>
